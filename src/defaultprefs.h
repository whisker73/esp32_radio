...
#
# MQTT settings
mqttbroker = 192.168.2.207
mqttport = 1883
mqttuser = none
mqttpasswd = none
mqqprefix = none
# Enter your WiFi network specs here:
wifi_00 = Gargoyle/Holger&star1103
#
volume = 72
toneha = 0
tonehf = 0
...
pin_tft_scl = 22                                      # GPIO Pin number for TFT "scl"
pin_tft_sda = 21                                       # GPIO Pin number for TFT "sda"
pin_vs_cs = 2                                        # GPIO Pin number for VS1053 "CS"
pin_vs_dcs = 15                                      # GPIO Pin number for VS1053 "DCS"
pin_vs_dreq = 4                                      # GPIO Pin number for VS1053 "DREQ"
#pin_spi_sck = 13
#pin_spi_miso = 15
#pin_spi_mosi = 16
